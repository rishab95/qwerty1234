	        ...
	        <div class="col-lg-6">
            	<div class="panel panel-default">
	    	        <div class="panel-heading">
    	               	<button class="btn btn-group" onClick="$('#password').slideToggle('slow');">Change Password</button>
   	    		    </div>
                
	                <div class="setting-panel panel-body" id="password">
	                    <form action="/controller/passwordUpdate" method="post" style="text-align: center;">
							...
							<div class="form-group">
    	                    	<button type="submit" class="btn btn-group">Change</button>
	                        </div>
                        </form>
            	    </div>
				</div>
