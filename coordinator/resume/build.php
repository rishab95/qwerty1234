...
<html>
	<head>
        ...
        <script>
			...
			$.post("/view/academicAchievement?view=resume", {username: user}, function(data){
				$("#acadAch").html(data);
			});
			// ajax for retrieving data for project record
			$.post("/view/project?view=resume", {username: user}, function(data){
				$("#proj").html(data);
			});
			// ajax for retrieving data for extra curricular record
			$.post("/view/extraCurr?view=resume", {username: user}, function(data){
				$("#extraCurr").html(data);
			});
			// ajax for retrieving data for other information record
			$.post("/view/otherInfo?view=resume", {username: user}, function(data){
				$("#otherInfo").html(data);
			});
		</script>
