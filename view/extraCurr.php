<?php
	ob_start();
	include_once("../controller/view/extraActivities.php");
	$inStr = ob_get_clean();
	...
	<div class="panel panel-default">
		<div class="panel-heading">
   		...
   		<div class="panel-body">
			...
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">
						<input type="checkbox" value="<?php echo $username.$input[$i]['id']; ?>" name="extraCurr[]" />
           	  		</span>
			...
			?>
            <p>No extra curricular activities found</p>
            <?php
				}
            ?>
        </div>
        ...
        <div class="panel-footer">
        	<div class="row">
            	<div class="col-xs-12">
		        	<form action="/controller/add/extraActivities" method="post" class="form-horizontal">
	                	<div class="input-group">
                        	<span class="input-group-addon">
