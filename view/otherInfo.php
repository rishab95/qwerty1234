<?php
	ob_start();
	include_once("../controller/view/otherInfo.php");
	$inStr = ob_get_clean();
	...
	<div class="panel panel-default">
		<div class="panel-heading">
   		...
   		<div class="panel-body">
			...
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">
						<input type="checkbox" value="<?php echo $username.$input[$i]['id']; ?>" name="otherInfo[]" />
           	  		</span>
			...
			?>
            <p>No other informations found</p>
            <?php
				}
            ?>
        </div>
        ...
        <div class="panel-footer">
        	<div class="row">
            	<div class="col-xs-12">
		        	<form action="/controller/add/otherInfo" method="post" class="form-horizontal">
	                	<div class="input-group">
                        	<span class="input-group-addon">
